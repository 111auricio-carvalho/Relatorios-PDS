...
\lstinputlisting[language=Matlab, caption={{Gerador do sinal senoidal}}]{codigos/parte1_e.m}
\begin{figure}[!htpb]
\centering
...
\lstinputlisting[language=Matlab, caption={{Operação $X_1[n] = 2A[n] - B[n]$}}]{codigos/parte2_a.m}
\begin{figure}[!htpb]
\centering
...
\lstinputlisting[language=Matlab, caption={{Operação $X_2[n] = A[n] + 3B[n]$}}]{codigos/parte2_b.m}
\begin{figure}[!htpb]
\centering
...
\lstinputlisting[language=Matlab, caption={{Operação $X_3[n] = X_2[-n]$}}]{codigos/parte2_c.m}
\begin{figure}[!htpb]
\centering
...
\lstinputlisting[language=Matlab, caption={{Equação $x[n]$ com impulsos deslocados}}]{codigos/parte3_a.m}
\begin{figure}[!htpb]
\centering
...
\lstinputlisting[language=Matlab, caption={{Equação $y[n]$ com impulsos deslocados}}]{codigos/parte3_b.m}
\begin{figure}[!htpb]
\centering
...
\lstinputlisting[language=Matlab, caption={{Item a) -- $\cos(0{,}1n - \pi)$, $n \in [-20, 20]$}}]{codigos/parte4_a.m}
\begin{figure}[!htpb]
\centering
...
\lstinputlisting[language=Matlab, caption={{Item b) -- $\cos(0{,}1n - \pi)$, $n \in [-10, 20]$}}]{codigos/parte4_b.m}
\begin{figure}[!htpb]
\centering
