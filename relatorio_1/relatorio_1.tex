...
\lstinputlisting[language=Matlab, caption={{Equação x[n].}}]{codigos/parte3_a.m}
\begin{figure}[!htpb]
\centering
...
\lstinputlisting[language=Matlab, caption={{Equação y[n].}}]{codigos/parte3_b.m}
\begin{figure}[!htpb]
\centering
...
\lstinputlisting[language=Matlab, caption={{Cossenoide no intervalo $[-20, 20]$.}}]{codigos/parte4_a.m}
\begin{figure}[!htpb]
\centering
...
\lstinputlisting[language=Matlab, caption={{Cossenoide no intervalo $[-10, 20]$.}}]{codigos/parte4_b.m}
\begin{figure}[!htpb]
\centering
