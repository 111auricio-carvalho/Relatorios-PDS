...
\definecolor{vscodeblue}{rgb}{0.34, 0.61, 0.84}
\definecolor{vscodegreen}{rgb}{0.29, 0.61, 0.40}
\definecolor{vscodeorange}{rgb}{0.81, 0.54, 0.39}
\definecolor{vscodeback}{rgb}{0.11, 0.11, 0.11}
\definecolor{vscodeline}{rgb}{0.5, 0.5, 0.5}

\lstset{
  language=Matlab,
  backgroundcolor=\color{vscodeback},   
  commentstyle=\color{vscodegreen},
  keywordstyle=\color{vscodeblue}\bfseries,
  numberstyle=\small\color{vscodeline},
