...
% ---- Configuração de cores para código Octave/MATLAB
\usepackage{xcolor}
...
% ----------------------------------------------------------------------------------------------------- %
\nocite{*}
\bibliographystyle{referencias_abnt/abntex2-alf}
